...
Winwheel.prototype.startAnimation = function () {
    if (this.animation) {
        ...
        properties[this.animation.propertyName] = this.animation.propertyValue; // Set the property to be animated and its value.
        properties['yoyo'] = this.animation.yoyo;     // Set others.
        properties['repeat'] = this.animation.repeat;
        properties['ease'] = this.animation.easing;
        properties['onUpdate'] = winwheelAnimationLoop;   // Call function to re-draw the canvas.
        properties['onComplete'] = winwheelStopAnimation;
        properties['duration'] = this.animation.duration; // Duration is in ms, we need to convert to seconds for GSAP.
